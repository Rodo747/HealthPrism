  ...
  return (
    <div className="app-shell" style={{paddingBottom:100}}>
      ...
      <div style={{padding:'20px 20px 0'}}>
        <div style={{marginBottom:14,padding:'12px 14px',background:'#FDECEA',borderRadius:12,display:'flex',gap:10,alignItems:'flex-start'}}><svg width='18' height='18' viewBox='0 0 24 24' fill='#E8291C' style={{flexShrink:0,marginTop:1}}><path d='M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1 15h-2v-2h2v2zm0-4h-2V7h2v6z'/></svg><p style={{fontSize:12,color:'#C01F14',fontWeight:600,lineHeight:1.5}}>Key anemia indicator — gently pull down the lower eyelid before taking the photo.</p></div>
        {captured ? (
          ...
          <CameraView videoRef={videoRef} shape="oval" instruction="Pull down lower eyelid gently and place it in the circle" onCapture={handleCapture} onFlip={flip} accentColor="#E8291C"/>
        )}
