...
const Home = () => {
  ...
  return (
    <div className="app-shell" style={{paddingBottom:80}}>
        ...
        {/* Hero banner */}
        <div style={{margin:'20px 20px 0',borderRadius:20,background:'linear-gradient(155deg, #08142E 0%, #4aa1db 50%, #4795c9 100%)',height:190,position:'relative',overflow:'hidden'}}>
          <div style={{position:'absolute',top:0,left:'25%',width:0,height:0,borderLeft:'90px solid transparent',borderRight:'90px solid transparent',borderBottom:'190px solid rgba(198,231,239,.18)'}}/>
          <div style={{position:'absolute',top:0,right:'15%',width:0,height:0,borderLeft:'55px solid transparent',borderRight:'55px solid transparent',borderBottom:'140px solid rgba(167,35,45,.15)'}}/>
          <div style={{position:'absolute',bottom:0,left:'10%',width:0,height:0,borderLeft:'40px solid transparent',borderRight:'40px solid transparent',borderTop:'80px solid rgba(167,35,45,.08)'}}/>
          ...
          <div style={{position:'absolute',bottom:14,left:14,background:'rgba(255,255,255,.96)',borderRadius:12,padding:'8px 12px'}}>
            <div style={{display:'flex',alignItems:'center',gap:5}}><div style={{width:7,height:7,borderRadius:'50%',background:'#a7232d'}}/><span style={{fontSize:9,fontWeight:700,color:'#3A4D66',textTransform:'uppercase',letterSpacing:'.07em'}}>Alert</span></div>
            <p style={{fontSize:12,fontWeight:800,color:'#08142E',marginTop:2}}>Growth Check</p>
          </div>
        </div>
        {/* Text */}
        <div style={{padding:'22px 20px 28px'}}>
          <span style={{background:'rgba(71,149,201,.1)',color:'#4795c9',padding:'5px 12px',borderRadius:999,fontSize:10,fontWeight:700,letterSpacing:'.07em',textTransform:'uppercase'}}>Clinical Artificial Intelligence</span>
          ...
          <h1 className="fade-up" style={{fontSize:36,fontWeight:800,lineHeight:1.12,fontFamily:'Syne,sans-serif',letterSpacing:'-.025em',fontStyle:'italic',background:'linear-gradient(135deg,#4795c9 30%,#a7232d 100%)',WebkitBackgroundClip:'text',WebkitTextFillColor:'transparent',marginBottom:14}}>digital precision.</h1>
      ...
      <div style={{padding:'20px 20px 0',display:'grid',gridTemplateColumns:'repeat(3,1fr)',gap:10}}>
        {[
           {label:'Quick Scan',color:'#4795c9',icon:<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#4795c9" strokeWidth="2"><path d="M23 19a2 2 0 0 1-2 2H3a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h4l2-3h6l2 3h4a2 2 0 0 1 2 2z"/><circle cx="12" cy="13" r="4"/></svg>},
           {label:'Clinical Analysis',color:'#4795c9',icon:<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#4795c9" strokeWidth="2"><polyline points="22 12 18 12 15 21 9 3 6 12 2 12"/></svg>},
           {label:'Total Privacy',color:'#a7232d',icon:<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#a7232d" strokeWidth="2"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>},
         ].map(f=>(
           <div key={f.label} className="card" style={{padding:'14px 10px',display:'flex',flexDirection:'column',alignItems:'center',gap:8}}>
             <div style={{width:40,height:40,borderRadius:12,background:'#c6e7ef',display:'flex',alignItems:'center',justifyContent:'center'}}>{f.icon}</div>
      ...
      <div style={{padding:'24px 20px 20px'}}>
        ...
        {[
          ...
          <div key={s.n} style={{display:'flex',gap:14,marginBottom:20,alignItems:'flex-start'}}>
             <div style={{width:42,height:42,borderRadius:14,flexShrink:0,display:'flex',alignItems:'center',justifyContent:'center',background:s.red?'linear-gradient(135deg,#a7232d,#c42b36)':'linear-gradient(135deg,#4795c9,#4aa1db)',boxShadow:s.red?'0 4px 14px rgba(167,35,45,.3)':'0 4px 14px rgba(71,149,201,.3)'}}>
