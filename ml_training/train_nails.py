...
IMG_SIZE   = 160
BATCH_SIZE = 16
DATA_DIR   = "datasets/nails"
MODEL_OUT  = "saved_models/nails_model.keras"
...
# Uñas: anémicas son minoría (202 vs 531) — oversample anémicas
repeat_factor = (n_non_anemic // max(n_anemic, 1)) + 1
balanced_ds = tf.data.Dataset.sample_from_datasets(
    [ds_anemic.shuffle(500).repeat(repeat_factor + 2), ds_non_anemic.shuffle(1000).repeat()],
...
steps_per_epoch = (n_non_anemic * 2) // BATCH_SIZE
...
np.save("saved_models/nails_threshold.npy", best_t)
