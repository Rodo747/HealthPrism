...
IMG_SIZE   = 160
BATCH_SIZE = 32
DATA_DIR   = "datasets/palm"
MODEL_OUT  = "saved_models/palm_model.keras"
...
balanced_ds = tf.data.Dataset.sample_from_datasets(
    [ds_anemic.shuffle(2000).repeat(), ds_non_anemic.shuffle(2000).repeat()],
...
steps_per_epoch = (min(n_anemic, n_non_anemic) * 2) // BATCH_SIZE
...
np.save("saved_models/palm_threshold.npy", best_t)
